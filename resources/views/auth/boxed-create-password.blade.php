...
@section('content')
    <div class="bg-cover bg-left-top bg-no-repeat bg-[url('/images/header_electrical-substation.jpg')] dark:bg-[url('/images/header_electrical-substation.jpg')] min-h-screen flex justify-center items-center">
        <div class="relative">
                ...
                <div class="grid lg:grid-cols-12 grid-cols-1 items-center gap-0">
                    ...
                    <div
                        ...
                        <div class="pt-10 px-10 h-full">
                            <div class="mt-auto">
                                <img alt="" src="{{ url('/images/header_electrical-substation.jpg') }}"/>
                            </div>
                        </div>
                    </div>
                </div>
