...
@section('content')
    <div class="bg-cover bg-no-repeat bg-left-top bg-[url('/images/header_electrical-substation.jpg')] dark:bg-[url('/images/header_electrical-substation.jpg')] min-h-screen flex justify-center items-center">
        <div class="relative">
